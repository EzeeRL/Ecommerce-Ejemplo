...
export default function Destacados() {
  ...
  return (
    <div className="relative flex flex-col justify-center items-center mt-[140px] w-full max-w-6xl mx-auto">
      ...
      {/* Panel de Filtros */}
      <div
        className={`fixed top-[170px] right-0 w-[400px] h-[350px] bg-secondary rounded-tl-xl rounded-bl-xl shadow-xl border border-black transition-transform duration-300s ${
