...
export default function Destacados() {
  ...
  return (
    <div className="relative flex flex-col justify-center items-center mt-[140px] h-[88vh] w-full mx-auto overflow-x-hidden overflow-y-hidden container-general-destacados">
